...
This document outlines steps required to set up and implement highly comparative analysis methods on a system using an interface between Matlab and a _mySQL_ database using the [*hctsa* code repository](https://github.com/SystemsAndSignalsGroup/hctsa).
