...
A valid output from a master operation is: (i) a real number, (ii) a structure containing real numbers, or (iii) a ‘NaN’ to indicate that the input time series is not appropriate for this code.
