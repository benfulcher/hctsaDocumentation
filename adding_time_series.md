...
Using an input .mat file is generally easier when the data is already stored as variables in Matlab, whereas the input text file method is better suited to when each time series is already stored as a text file.
