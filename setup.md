...
2. Populates the database with our default library of master operations and operations (using `SQL_add` commands), described [here](populating.md). (a description of the terminology of 'master operations' and 'operations' is provided [here](populating.md)).
