...
Once this one-off installation step is complete, you're ready to go! (You can optionally compile TISEAN routines for your system). Future use can start by simply loading the paths required by the *hctsa* package using the `startup` script.
