...
2. Normalized it, using `TSQ_normalize('scaledSQzscore',[0.7,0.9])`. This removed 1 time series with fewer than 70% good values and 3011 operations with fewer than 90% good values and 136 operations with near-constant outputs after normalization, leaving a 998 x 6645 normalized data matrix containing 0.38% special values saved in **HCTSA_N.mat**.
