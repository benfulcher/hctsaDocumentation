...
However, the latency in this step means that the computation can be distributed across multiple compute nodes, and that data can be retrieved systematically.