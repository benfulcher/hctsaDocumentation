...
In this case the two labeled groups of time series are recognized by the function, which then plots 5 examples of each, including the first 500 samples of each time series.